%% Extracting Features for Parkinson's Data
...
%      spec_lef = slowenergy(x_overlap);
     ...
     combo_all{i} = [combo_bark combo_gfcc combo_mfcc combo_stat combo_pitch combo_spec combo_loud combo_lpc Jitt_Shimm_pd(i,:)];
     %disp(length(combo_all{i}))
     train_input_PD(i,:) = combo_all{i};
end
save('train_input_PD.mat','train_input_PD')
